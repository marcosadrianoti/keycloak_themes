...
<div class="flex flex-col min-h-screen items-center justify-center mb-0 font-Jakarta font-semibold text-base">
    <@layout.registrationLayout displayMessage=messagesPerField.exists('global') displayRequiredFields=true displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
        <#if section = "header">
                        ...
                        <#list social.providers as p>
                            <li class="flex items-center justify-center font-Jakarta text-sm gap-5">
                                <span class="text-sm font-medium text-gray-500">
                                    ${msg("identity-provider-create-label")}
                                </span>
                                <a 
            ...
            <div class="py-5 flex items-center text-xs uppercase before:flex-1 before:border-t before:border-blue-500 before:me-6 after:flex-1 after:border-t after:border-blue-500 after:ms-6 dark:before:border-blue-500 dark:after:border-blue-500">
                ou
            </div>
                ...
                <div class="mb-0">
                    ...
                    >
                        ...
                        <div class="flex flex-col items-center justify-center">
                            <span class="font-Jakarta text-sm font-medium text-gray-500">
                                ${msg("doHaveAnAccount")}
                            </span>
